...
namespace System.Text.Json
{
    public sealed partial class Utf8JsonWriter
    {
        ...
        /// <summary>
        /// Writes the pre-encoded property name and <see cref="TimeOnly"/> value (as a JSON string) as part of a name/value pair of a JSON object.
        /// </summary>
        ...
        /// </exception>
        /// <remarks>
        /// Writes the <see cref="TimeOnly"/> using the round-trippable ('O') <see cref="StandardFormat"/> , for example: 2017-06-12T05:30:45.7680000.
        ...
        /// <summary>
        /// Writes the property name and <see cref="TimeOnly"/> value (as a JSON string) as part of a name/value pair of a JSON object.
        /// </summary>
        ...
        private void WriteStringEscape(ReadOnlySpan<char> propertyName, TimeOnly value)
        {
        ...
        private void WriteStringEscape(ReadOnlySpan<byte> utf8PropertyName, TimeOnly value)
        {
        ...
        private void WriteStringEscapeProperty(ReadOnlySpan<char> propertyName, TimeOnly value, int firstEscapeIndexProp)
        {
        ...
        private void WriteStringEscapeProperty(ReadOnlySpan<byte> utf8PropertyName, TimeOnly value, int firstEscapeIndexProp)
        {
        ...
        private void WriteStringByOptions(ReadOnlySpan<char> propertyName, TimeOnly value)
        {
        ...
        private void WriteStringByOptions(ReadOnlySpan<byte> utf8PropertyName, TimeOnly value)
        {
            ValidateWritingProperty();
            if (_options.Indented)
            {
        ...
        private void WriteStringMinimized(ReadOnlySpan<char> escapedPropertyName, TimeOnly value)
        {
        ...
        private void WriteStringMinimized(ReadOnlySpan<byte> escapedPropertyName, TimeOnly value)
        {
            throw new NotImplementedException();
        ...
        private void WriteStringIndented(ReadOnlySpan<char> escapedPropertyName, TimeOnly value)
        {
            throw new NotImplementedException();
        ...
        private void WriteStringIndented(ReadOnlySpan<byte> escapedPropertyName, TimeOnly value)
        {
            throw new NotImplementedException();
        ...
        internal void WritePropertyName(TimeOnly value)
        {
            throw new NotImplementedException();
